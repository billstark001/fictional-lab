import{j as n,s as c,I as g,r as m,h as f,G as y,L as p,i as A,b,c as P,d as S,o as v}from"../chunks/chunk-C4h2c8gr.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DldSpnpZ.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */function j(e){const r=[];let t="",a=0;for(let i=0;i<e.length;i++){const o=e[i];if(o==="{"?a++:o==="}"&&a--,a===0&&e.slice(i,i+5).toLowerCase()===" and "){r.push(t),t="",i+=4;continue}t+=o}return r.push(t),r.map(i=>i.trim()).filter(i=>i.length>0).map(i=>{const o={first:"",middle:[],last:""};if(i=i.replace(/^\{|\}$/g,"").trim(),i.includes(",")){const[s,d]=i.split(",").map(l=>l.trim());if(o.last=s,d){const l=d.split(/\s+/);o.first=l[0]||"",o.middle=l.slice(1)}}else{const s=i.split(/\s+/);s.length===1?o.last=s[0]:(o.first=s[0],o.last=s[s.length-1],o.middle=s.slice(1,-1))}return o})}const C=e=>{const{errors:r,raw:t}=e;if(r!=null&&r.length)return n.jsxs("div",{className:"c1xtvhbp",children:[n.jsx("pre",{children:n.jsx("code",{children:t})}),"Errors occurred while parsing the citation:",r.map((a,i)=>n.jsx("div",{children:a},i))]})},I=c("div")({name:"AuthorListWrapper",class:"a1u4owzb",propsAsIs:!1}),w=e=>{var a;if(!e||(a=e.middle)!=null&&a.length||!e.last||!e.first)return!1;const r=e.first.toLowerCase().trim();return e.last.toLowerCase().trim()==="doe"&&(r==="jane"||r==="j.")},x=e=>`${e.first} ${e.middle.join(" ")} ${e.last}`.trim(),D=e=>{const r=m.useMemo(()=>j(e.entry.author??""),[e.entry.author]);return n.jsx(I,{children:r.map((t,a)=>t&&n.jsx("span",{className:f("author",w(t)&&"highlight"),children:x(t)},a))})},E=e=>{const{entry:r}=e;let t="";r.journal&&(t=`${r.journal}`,r.volume&&(t+=`, ${r.volume}`),r.pages&&(t+=`: ${r.pages}`));const a=r.journal||r.booktitle||void 0;return n.jsxs(n.Fragment,{children:[!!r.year&&n.jsxs("span",{children:["(",r.year,")"]}),n.jsxs("span",{children:[" ",r.title,"."]}),a&&n.jsxs("span",{children:[" ",a,"."]}),r.publisher&&n.jsxs("span",{children:[" ",r.publisher,"."]})]})},T=c("div")({name:"PublicationWrapper",class:"p9taii5",propsAsIs:!1}),k=c("a")({name:"DOILink",class:"d2m9rft",propsAsIs:!1}),z=({entry:e,index:r})=>n.jsxs(T,{children:[!!r&&n.jsxs("span",{children:["[",r,"] "]}),n.jsx(D,{entry:e}),n.jsx("span",{children:". "}),n.jsx(E,{entry:e}),!!e.doi&&n.jsxs(k,{href:`https://doi.org/${e.doi}`,target:"_blank",rel:"noopener noreferrer",children:["DOI: ",e.doi]}),n.jsx(C,{errors:e.errors,raw:e.raw}),!!e.url&&n.jsx("a",{className:"cite-copy clickable-icon",href:e.url,children:n.jsx(g,{})})]}),h=({entries:e,headCharacter:r})=>n.jsx("div",{children:e.map((t,a)=>n.jsx(z,{entry:t,index:r?`${r}${a+1}`:a+1},a))}),L=[{id:"lee2025personalized",type:"misc",raw:`@misc{lee2025personalized,\r
