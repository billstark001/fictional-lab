import{w as a,j as e,s as l,L as m,i as p,b as u,c as g,d as h,o as f}from"../chunks/chunk-DlgMXoIh.js";import{M as j}from"../chunks/chunk-CZowRMQ4.js";/* empty css                      *//* empty css                      */import"../chunks/chunk-BiBGCRHz.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const y=a({en:()=>e.jsxs(e.Fragment,{children:[e.jsx("h1",{children:"Summary"}),"At Fictional Lab, we focus on solving some of the most pressing scientific and technological challenges of our time. Below are our primary research domains, along with specific projects and goals."]}),ja:()=>e.jsxs(e.Fragment,{children:[e.jsx("h1",{children:"サマリー"}),"フィクション・ラボでは、現代における最も差し迫った科学技術的課題 の解決に注力しています。以下は、私たちの主な研究領域と、 具体的なプロジェクトや目標です。"]}),zh:()=>e.jsxs(e.Fragment,{children:[e.jsx("h1",{children:"总览"}),"在虚构实验室，我们专注于解决当代一些最紧迫的科学和技术挑战。 以下是我们的主要研究领域以及具体项目和目标。"]})}),x=l("div")({name:"TopicContainer",class:"t1165wf9",propsAsIs:!1}),T=l("img")({name:"TopicImage",class:"tleklrz",propsAsIs:!1}),t=i=>{const{image:d,content:c}=i;return e.jsxs(x,{children:[e.jsx(T,{src:d}),e.jsx("div",{className:"content",children:e.jsx(j,{children:c})})]})},o="/assets/static/artificial_intelli_image.DcTGxDsc.jpg",n="/assets/static/robotics_and_autom_image.DaWGlTku.jpg",s="/assets/static/computational_biol_image.C_j3MTHD.jpg",r="/assets/static/social_systems_and_image.CVlEeB1M.jpg",S=a({en:()=>e.jsx(t,{image:o,content:`
...
- 为老年人护理和康复创建机器人助手。
- 探索基于无人机的环境监测和农业解决方案。
`})}),A=a({en:()=>e.jsx(t,{image:s,content:`
...
`})}),z=a({en:()=>e.jsx(t,{image:r,content:`
