  ...
  return <ButtonGroup {...props}>
    <a href={withLocale('/research')}>
      <LinkButton>
        <FaMicrochip />
        <Localized>{
          ({ locale }) => locale === 'zh' ? '研究室概要' : locale === 'ja' ? '研究室概要' : 'Lab Introduction'
        }</Localized>
      </LinkButton>
    </a>
  </ButtonGroup>;
  ...
  return <ButtonGroup {...props}>
    <a href={withLocale('/news')}>
      <LinkButton>
        <FaNewspaper />
        <Localized>{
          ({ locale }) => locale === 'zh' ? '浏览所有新闻' : locale === 'ja' ? 'すべてのニュース' : 'View All Newses'
        }</Localized>
      </LinkButton>
    </a>
    <a href={withLocale('/articles')}>
      <LinkButton>
        <FaNewspaper />
        <Localized>{
          ({ locale }) => locale === 'zh' ? '浏览所有文章' : locale === 'ja' ? 'すべての文章' : 'View All Articles'
        }</Localized>
      </LinkButton>
    </a>
  </ButtonGroup>;
